...
%       sig --- Nc x L
% IMF - is a cell array, each cell contain a multivariate intrinsic mode function (MIMF)
%       corresponding to all channels. For example cell (1,1) contaion first MIMF corresponding
%       to all channels.
%
% Example:
%       x = rand(5,1000);
